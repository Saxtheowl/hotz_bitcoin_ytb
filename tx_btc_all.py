...
MAGIC_BITCOIN = 0xd9b4bef9
MAGIC_BITCOIN_TESTNET = 0xdab5bffa

PEER_CASH = 'seed.bitcoinabc.org'
PEER_BITCOIN = 'dnsseed.bluematt.me'
PEER_BITCOIN_TESTNET = 'seed.tbtc.petertodd.org'

def makeMessage(command, payload):
  return struct.pack('<L12sL4s', MAGIC_BITCOIN_TESTNET, command, len(payload), checksum(payload)) + payload
...
#  publ_addr2 = "1Lg2KRDk6CWfy1K6vi7rVqtBYMYdBZvXu4"
  ...
  #exit(0)
  peers = socket.gethostbyname_ex(PEER_BITCOIN_TESTNET)[2]
